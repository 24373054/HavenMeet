    ...
    async def launch_browser(
        ...
        if config.SAVE_LOGIN_STATE:
            ...
            browser_context = await chromium.launch_persistent_context(
                ...
                executable_path=config.CUSTOM_BROWSER_PATH or None,  # Use custom browser path
            )
            return browser_context
        else:
            browser = await chromium.launch(headless=headless, proxy=playwright_proxy, executable_path=config.CUSTOM_BROWSER_PATH or None)  # type: ignore
